...
describe('Service Tests', () => {
    describe('Proba Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ProbaService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/probas';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Proba', () => {
                service.create(new Proba(null)).subscribe(received => {
            ...
            it('should update a Proba', () => {
                service.update(new Proba(123)).subscribe(received => {
