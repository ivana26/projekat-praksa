...
public class OnlineOrderItem implements Serializable {
    ...
    public Article getOnlineArticle() {
        return onlineArticle;
    }

    public OnlineOrderItem onlineArticle(Article article) {
        this.onlineArticle = article;
        return this;
    }

    public void setOnlineArticle(Article article) {
        this.onlineArticle = article;
    }
